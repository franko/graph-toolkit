...
echo "Using Lua: $LGT_LUA"

mkdir debian_build/DEBIAN

cat debian/control | sed "s/LGT_VERSION/$VERSION/;s/LGT_INSTALLED_SIZE/$LGT_ISIZE/;s/LGT_ARCH/$LGT_ARCH/;s/LGT_LUA/$LGT_LUA/" - > debian_build/DEBIAN/control
